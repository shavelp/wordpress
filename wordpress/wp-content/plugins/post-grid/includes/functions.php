			...
			foreach($layout as $item_key=>$item_info){
				...
				?>
					...
					elseif($item_key=='excerpt_read_more'){
						...
						?>
						Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text <a href="#">Читать далее</a>
						<?php
						}					
...
function post_grid_layout_add_elements(){
	...
	if(current_user_can('manage_options')){
		...
		elseif($item_key=='excerpt_read_more'){
			$html['item'].= 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text <a href="#">Читать далее</a>';
	
			}					
			
		elseif($item_key=='read_more'){
			$html['item'].= '<a href="#">Читать далее</a>';
