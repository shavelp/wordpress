	...
	public function layout_content_list(){
		...
		$layout_content_list = array(
						...
						'flat'=>array(
								...
								'2'=>array('key'=>'read_more', 'name'=>'Читать далее', 'css'=>'display: block;font-size: 12px;font-weight: bold;padding: 0 10px;text-align: left;', 'css_hover'=>''),
						...
						'flat-center'=>array(												
								...
								'2'=>array('key'=>'read_more', 'name'=>'Читать далее', 'css'=>'display: block;font-size: 12px;font-weight: bold;padding: 0 10px;text-align: center;', 'css_hover'=>''),
						...
						'flat-right'=>array(												
								...
								'2'=>array('key'=>'read_more', 'name'=>'Читать далее', 'css'=>'display: block;font-size: 12px;font-weight: bold;padding: 0 10px;text-align: right;', 'css_hover'=>''),					
									),
	...
	public function layout_hover_list(){
		...
		$layout_hover_list = array(
						...
						'flat'=>array(												
								...
								'read_more'=>array('name'=>'Читать далее', 'css'=>'display: block;font-size: 12px;font-weight: bold;padding: 0 10px;text-align: center;')
									),										
						'flat-center'=>array(												
